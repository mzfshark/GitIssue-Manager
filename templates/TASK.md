...
- [ ] <Subtask title> [labels:type:task, area:<area>] [status:TODO] [priority:MEDIUM] [estimate:3h] [start:YYYY-MM-DD] [end:YYYY-MM-DD]
- [ ] <Subtask title> [labels:type:task, area:<area>] [status:TODO] [priority:LOW] [estimate:2h] [start:YYYY-MM-DD] [end:YYYY-MM-DD]
